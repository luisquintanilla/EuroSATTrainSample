...
using EuroSATTrainSampleML.Model;
using Microsoft.ML.Vision;

namespace EuroSATTrainSampleML.ConsoleApp
{
    public static class ModelBuilder
    {
        private static string TRAIN_DATA_FILEPATH = @"C:\Users\luquinta.REDMOND\AppData\Local\Temp\c02389e6-16a5-489d-9f26-c60a37ae5972.tsv";
        private static string MODEL_FILEPATH = @"../../../../EuroSATTrainSampleML.Model/MLModel.zip";
